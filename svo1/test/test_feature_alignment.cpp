...
#include <svo1/feature_alignment.h>
#include <vikit1/timer.h>
#include <vikit1/aligned_mem.h>
...
int main(int argc, char **argv)
{
  ...
  for(int i=0; i<1000; ++i)
  {
    ...
    svo1::feature_alignment::align1D(img, dir, ref_patch_with_border.data, ref_patch, 3, px_est, h_inv);
  }
  ...
  {
    px_est = px_true-px_error;
    svo1::feature_alignment::align2D(img, ref_patch_with_border.data, ref_patch, 3, px_est, true);
  }
  e = px_est-px_true;
  ...
  {
    px_est = px_true-px_error;
    svo1::feature_alignment::align2D_SSE2(img, ref_patch_with_border.data, ref_patch, 3, px_est);
  }
  e = px_est-px_true;
  ...
  {
    px_est = px_true-px_error;
    svo1::feature_alignment::align2D_NEON(img, ref_patch_with_border.data, ref_patch, 3, px_est);
  }
  e = px_est-px_true;
