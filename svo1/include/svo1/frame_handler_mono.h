...
#ifndef SVO1FRAME_HANDLER_H_
#define SVO1FRAME_HANDLER_H_

#include <set>
#include <vikit1/abstract_camera.h>
#include <svo1/frame_handler_base.h>
#include <svo1/reprojector.h>
...
protected:
  vk::AbstractCamera* cam_;                     //!< Camera model, can be ATAN, Pinhole or Ocam (see vikit1).
