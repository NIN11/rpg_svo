    ...
    std::vector< std::pair<FramePtr,std::size_t> >& overlap_kfs)
{
  ...
  SVO1STOP_TIMER("reproject_kfs");

  // Now project all point candidates
  SVO1START_TIMER("reproject_candidates");
  {
  ...
  SVO1STOP_TIMER("reproject_candidates");
