...
#include <vikit1/output_helper.h>
#include <vikit1/params_helper.h>
#include <deque>
#include <algorithm>
#include <svo1_msgs/DenseInput.h>
...
Visualizer() :
    pnh_("~"),
    trace_id_(0),
    img_pub_level_(vk::getParam<int>("svo1/publish_img_pyr_level", 0)),
    img_pub_nth_(vk::getParam<int>("svo1/publish_every_nth_img", 1)),
    dense_pub_nth_(vk::getParam<int>("svo1/publish_every_nth_dense_input", 1)),
    publish_world_in_cam_frame_(vk::getParam<bool>("svo1/publish_world_in_cam_frame", true)),
    publish_map_every_frame_(vk::getParam<bool>("svo1/publish_map_every_frame", false)),
    publish_points_display_time_(vk::getParam<double>("svo1/publish_point_display_time", 0)),
    T_world_from_vision_(Matrix3d::Identity(), Vector3d::Zero())
{
  ...
  pub_info_ = pnh_.advertise<svo1_msgs::Info>("info", 10);
  pub_dense_ = pnh_.advertise<svo1_msgs::DenseInput>("dense_input",10);
