...
import argparse
import yaml
import svo1_analysis.analyse_logs as analyse_logs
import svo1_analysis.analyse_timing as analyse_timing
import svo1_analysis.analyse_trajectory as analyse_trajectory
import svo1_analysis.analyse_depth as analyse_depth
...
if __name__=="__main__":
    ...
    trace_dir = os.path.join(rospkg.RosPack().get_path('svo1_analysis'),
                             'results',
