...
if __name__ == '__main__':
    ...
    comparison_params_file = os.path.join(rospkg.RosPack().get_path('svo1_analysis'),
    ...
    comparison_dir = os.path.join(rospkg.RosPack().get_path('svo1_analysis'),
                                  'comparisons', comp_params['comparison_name'])
    if not os.path.exists(comparison_dir):
        os.makedirs(comparison_dir)

    # folder where the results of previous experiments are saved
    results_dir = os.path.join(rospkg.RosPack().get_path('svo1_analysis'), 'results')
